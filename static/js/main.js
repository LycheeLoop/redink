        ...
        newsletterForm.addEventListener('submit', function (event) {
            ...
            fetch('/newsletter', {
                ...
                .then(data => {
                    ...
                    if (flashMessageDiv) {
                        flashMessageDiv.innerHTML = `<p class="flash ${data.category}">${data.message}</p>`;
                    }
                })
    ...
    if (signupForm) {
        signupForm.addEventListener('submit', function (event) {
            ...
            fetch('/signup', {
                ...
                .then(response => response.json())
                .then(data => {
                    const flashMessageDiv = document.getElementById('signup-flash-message');
                    if (flashMessageDiv) {
                        flashMessageDiv.innerHTML = `<p class="flash ${data.category}">${data.message}</p>`;
                    }
                })
        ...
        loginForm.addEventListener('submit', function (event) {
            ...
            fetch('/login', {
                ...
                .then(data => {
                    ...
                    const flashMessageDiv = document.getElementById('login-flash-message');
                    if (flashMessageDiv) {
                        flashMessageDiv.innerHTML = `<p class="flash ${data.category}">${data.message}</p>`;
                    }
                ...
                .catch(error => {
                    ...
                    const flashMessageDiv = document.getElementById('login-flash-message');
                    if (flashMessageDiv) {
                        flashMessageDiv.innerHTML = `<p class="flash error">An unexpected error occurred. Please try again.</p>`;
                    }
                });
        });
    }
